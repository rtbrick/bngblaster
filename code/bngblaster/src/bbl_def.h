...
/* Mock L2TP IPv6 WAN/PD prefixes (random ULA) */
static const ipv6_prefix mock_l2tp_ipv6_ra_prefix = {
    .len = 64,
    .address = {0xFD, 0x6C, 0x2C, 0x3F, 0x7A, 0x91, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
};
static const ipv6addr_t mock_l2tp_ipv6_ia_na = {
    0xFD, 0x6C, 0x2C, 0x3F, 0x7A, 0x91, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02
};
static const ipv6_prefix mock_l2tp_ipv6_ia_pd = {
    .len = 56,
    .address = {0xFD, 0x6C, 0x2C, 0x3F, 0x7A, 0x91, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
};
